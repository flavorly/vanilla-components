...
import VanillaCard from './card.vue'
...
import VanillaDatatableHead from './datatable/head.vue'
import VanillaDatatableRowSkeleton from './datatable/row-skeleton.vue'
import VanillaDatatableSearch from './datatable/search-bar.vue'
import VanillaDatatableSelectionBar from './datatable/selection-bar.vue'
import VanillaDatatablePagination from './datatable/pagination.vue'
import VanillaDatatableActions from './datatable/actions.vue'
import VanillaDatatableDialogConfirmAction from './datatable/dialog-confirm-action.vue'
import VanillaDatatableDialogSettings from './datatable/dialog-settings.vue'
import VanillaDatatableDialogFilters from './datatable/dialog-filters.vue'
import VanillaDatatableFilterBadge from './datatable/filter-badge.vue'
import VanillaDatatableEmptyState from './datatable/empty-state.vue'
...
import type {
    ...
    VanillaDatatableClassesValidKeys,
    ...
    VanillaDatatableTranslations, VanillaDatatableUserSettings,
} from './datatable'
...
export default defineComponent({
    ...
    setup(props, { emit }) {
        ...
        const filtersComputed = computed(() => {
            const finalFilters = [] as VanillaDatatableFilters
            Object.entries(userSettings.filters).forEach(([key, value]) => {
                const filterObject = find(datatable.filters, { name: key }) as VanillaDatatableFilter | undefined
