...
import type { VanillaRichSelectOptionWithImageProps } from './rich-select-option-image'
import { VanillaRichSelectOptionWithImageClassesKeys, VanillaRichSelectOptionWithImageConfig } from './rich-select-option-image'
