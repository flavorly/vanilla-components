...
import type { VanillaRichSelectOptionWithImageProps } from './index'
import { VanillaRichSelectOptionWithImageClassesKeys, VanillaRichSelectOptionWithImageConfig } from './index'
