<template>
  ...
  /><path
    fill="#c00"
    d="M0 0h1400v200H0z"
  /><g fill="#f8c300"><path d="M672 340.7a12.5 12.5 0 0123.3 5.9v50h9.4v-50a12.5 12.5 0 0123.3-5.9 29.5 29.5 0 10-56 0" /><path
  ...
  /><path
    ...
    stroke-width="16"
    stroke="#f8c300"
  /><g transform="translate(700 380)"><g transform="translate(0 -140)"><path
    id="c"
