<template>
  ...
  ><defs><clipPath id="b"><path d="M0 0h600v300H0z" /></clipPath><clipPath id="c"><path d="M0 0l300 150H0zm300 0h300L300 150zm0 150h300v150zm0 0v150H0z" /></clipPath><g id="d"><g id="a"><path
    d="M0 0v.5L1 0z"
  ...
  /><g transform="rotate(82 900 240)"><use
    xlink:href="#d"
    fill="#FFF"
  ...
  /></g><g transform="rotate(82 900 240)"><use
    xlink:href="#d"
    fill="#FFF"
